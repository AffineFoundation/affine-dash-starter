    ...
    <header className="z-50 fixed top-0 left-0 right-0 h-20 bg-slate-100 dark:bg-dark-100">
      <div className="mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6">
          ...
          <button
            onClick={toggleTheme}
            className="rounded-full p-3 transition-colors duration-500 text-gray-700 hover:bg-gray-100 dark:text-dark-500 dark:hover:bg-dark-300 dark:hover:text-dark-highlight"
          >
