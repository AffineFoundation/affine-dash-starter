...
const OverviewTable: React.FC<OverviewTableProps> = ({ theme }) => {
  ...
  useEffect(() => {
    ...
    const toFetch = pagedRows
      ...
      .filter(
        (r) =>
          Number.isFinite(r.uid) &&
          r.model &&
          !enrichedMap[liveKey(r.uid, r.model)],
      )
    ...
    enrichLiveSubnetRows(toFetch)
      .then((rows) =>
        setEnrichedMap((prev) => ({
          ...prev,
          ...Object.fromEntries(rows.map((r) => [liveKey(r.uid, r.model), r])),
        })),
      )
  ...
  return (
    <div className="space-y-4 text-gray-900 dark:text-dark-500">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className={`h-8 px-2 border text-xs font-sans rounded-sm ${
              theme === 'dark'
      ...
      {/* Models Table */}
      <div
        className={`border-2 rounded-none overflow-x-auto ${
          theme === 'dark'
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className={`${gridCols} text-center`}>
                      <div
                        className={`text-sm font-sans font-bold tabular-nums whitespace-nowrap`}
                      >
                        {model.uid}
                      </div>
                      <div
                        ...
                        <div className="relative">
                          ...
                          {openMenuId === model.uniqueId && (
                            ...
                            >
                              ...
                              <div
                                className={`px-3 py-2 border-t text-[11px] font-sans opacity-70 ${
                                  theme === 'dark'
                                    ? 'border-white/30'
                                    : 'border-gray-300'
                                }`}
