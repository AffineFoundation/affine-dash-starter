...
import { MinerEfficiencyCostRow } from '@/lib/types'
import {
  ResponsiveContainer,
  ScatterChart,
  CartesianGrid,
...
const CostPerformanceScatter: React.FC<Props> = ({ theme, data, errorMessage }) => {
